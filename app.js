...
const updatePage = async () => {
  ...
  const filterData = fruitsArray.filter((fruit) => {
    return fruit.nutritions.sugar > 7
  })
  ...
  while (i < filterData.length) {
    fruitNames.push(filterData[i].name);
    i++;
  }
